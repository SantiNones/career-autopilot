...
const TERM_RULES: TermRule[] = [
  ...
  { terms: ["customer interaction", "customer-facing", "customer facing", "client engagement", "customer engagement", "client relationship"], capabilities: [{ id: "customer_communication", confidence: "high" }] },
  ...
  { terms: ["demo", "demonstration", "proof-of-concept", "proof of concept", "poc"], capabilities: [{ id: "product_demos", confidence: "high" }] },
